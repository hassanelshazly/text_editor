...
public abstract class Document {
	...
	/** This is overload version of getTokens to support other texts
	 */
	...
	protected int countSyllables(String word)
	{
		...
		List<String> syllables = getTokens("[aeouiyAEOUIY]+", word);
		if(syllables.size() == 0) return 1;
		if(syllables.get(syllables.size()-1).equals("e") &&
				word.endsWith("e") && syllables.size() > 1) 
		{
